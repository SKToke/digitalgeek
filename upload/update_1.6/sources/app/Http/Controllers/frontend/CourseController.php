...
{
    public function index_live(Request $request)
    {
        return $this->index($request, c_course_type: 'live');
    }

    public function index(Request $request, $category = '', $c_course_type = null)
    {
        ...
        $query = Course::join('users', 'courses.user_id', '=', 'users.id')
            ...
            ->when($c_course_type, function ($query, $c_course_type) {
                return $query->where('c_course_type', $c_course_type);
            })
        ...
        // filter by c_course_type
        if (request()->has('c_course_type')) {
            $c_course_type = request()->query('c_course_type');
            $query = $query->where('c_course_type', $c_course_type);
        }
