        ...
        <div class="row flex-md-nowrap">
                ...
                <div class="header-menu d-flex justify-content-end me-lg-auto ms-lg-0 ms-auto mt-2 pt-1">
                    <div class="nav-menu w-100">
                        <ul class="primary-menu main-menu-ul d-flex align-items-center w-100">
                            ...
                            <li class="pe-2 ps-5"><a href="{{ route('courses.live') }}"
                                                     class="@if ($current_route == 'courses.live' || $current_route == 'courses.live') active @endif">{{ get_phrase('Live Courses') }}</a>
                            </li>
            ...
            <div class="col-sm-5 col-md-3 col-xl-4 ms-lg-0 col-auto ms-auto">
                <form action="{{ route('courses') }}" method="get"
                    ...
                    <input type="text" name="search" class="form-control" placeholder="{{ get_phrase('Search...') }}"
                ...
                <div class="floating-searchbar d-inline-block d-sm-none @auth loged-in @endauth">
                    ...
                    <form action="{{ route('courses') }}" method="get">
                        <input type="text" name="search" class="form-control"
                               @if (request()->has('search')) value="{{ request()->input('search') }}"
                               @endif placeholder="{{ get_phrase('Search courses') }}">
                        <button type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                    </form>
                </div>
            </div>
            <div class="ms-lg-auto col-auto">
                <div class="primary-end d-flex align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @isset(auth()->user()->id)
                            <a href="{{ route('cart') }}" class="me-2 me-md-4 position-relative"
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                           href="{{ route(auth()->user()->role . '.dashboard') }}">
                                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" id="dashboard-icon"
                                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    text-dark ms-0" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions"
                ...
                <div class="off-menu">
                    ...
                    <div class="mt-3 flex-shrink-0">
                        <ul class="list-unstyled ps-0">
                            @auth
                                ...
                                @if (auth()->user() && auth()->user()->role == 'student' || auth()->user() && auth()->user()->role == 'instructor')
                                    ...
                                    <li><a href="{{ route('my.courses') }}"
                                           class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"> {{ get_phrase('My Courses') }}</a>
                                    </li>
                                    <li><a href="{{ route('wishlist') }}"
                                           class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"> {{ get_phrase('Wishlist') }}
                                            <span class="badge bg-pink ms-auto">{{ $numberof_wishlist_item }}</span></a>
                                    </li>
                                    {{-- ebook start --}}
                                    <li>
                                    ...
                                    <li><a href="{{ route('my.profile') }}"
                                           class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"> {{ get_phrase('My profile') }}</a>
                                    </li>
                                    <li><a href="{{ route('message') }}"
                                           class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"> {{ get_phrase('Message') }}</a>
                                    </li>
                                    <li><a href="{{ route('purchase.history') }}"
                                           class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"> {{ get_phrase('Purchase History') }}</a>
                                    </li>
                                @elseif (auth()->user() && auth()->user()->role == 'admin')
                                    <li><a href="{{ route('admin.dashboard') }}"
                                           class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"> {{ get_phrase('Admin Dashboard') }}</a>
                                    </li>
                                @endif
                                <li>
                                    <hr>
                            ...
                            <li><a href="{{ route('home') }}"
                                   class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"> {{ get_phrase('Home') }}</a>
                            </li>
                            <li>
                                <button
