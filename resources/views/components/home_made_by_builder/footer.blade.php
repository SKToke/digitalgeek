        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="footer-content">
                    ...
                    <p class="description builder-editable"
                       builder-identity="1">{{ get_phrase("It is a long established fact that a reader will be the distract by the read content of a page layout.") }}</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('knowledge.base.topicks') }}">{{ get_phrase('Knowledge Base') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('certificate-verify.index') }}">{{ get_phrase('Certificate Verify') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="newslater-bottom">
                                ...
                                <p class="description builder-editable"
                                   builder-identity="3">{{ get_phrase("Subscribe to stay tuned for new web design and latest updates. Let's do it!") }}</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="copyright-text">
                        <p class="builder-editable"
                           builder-identity="4">{{ get_phrase("© 2024 All Rights Reserved") }}</p>
                    </div>
                </div>
            </div>
        </div>
